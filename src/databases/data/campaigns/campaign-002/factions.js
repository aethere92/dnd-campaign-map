const CAMPAIGN_002_FACTIONS = [
	{
		...
		type: 'Enemy',
		encounters: [
			{ session: 1, description: 'Both Soshi and Norr were part of the brotherhood.' },
			{
				session: 4,
				description:
					'Found half-burned ledger mentioning the brotherhood failing to send reinforcements, signed by Kalistra.',
			},
			{
				session: 5,
				description:
					'Commanders Turiados and Bianca were seen in the possession of a Breaker of Hulls cutlass and a storm-forged glass blade Winder, originally brotherhood relics.',
			},
			{
				session: 7,
				description:
					'Former teacher of Norr and Soshi, Kalistra, was found bound to the Null Brand artefact, still alive, but aged and corrupted.',
			},
		],
	},
	{
