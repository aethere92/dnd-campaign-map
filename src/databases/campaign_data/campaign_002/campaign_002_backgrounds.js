const CAMPAIGN_02_BACKGROUNDS = {
	...
	KAEDIN: {
        ...
        <p>As a child, [ENTITY:character:Kaedin] was clever, energetic, and always on the verge of mischief. His constant partner in trouble was [ENTITY:npc:Thalos], the son of stoic, deeply religious Earth Genasi parents who upheld every tradition with unwavering reverence. [ENTITY:npc:Thalos] always wore his people's ceremonial robes, stiff with cultural pride and stitched with sacred patterns of stone. [ENTITY:character:Kaedin] mocked them at first—he found them impractical, absurd for cave diving and running through the hills. But [ENTITY:npc:Thalos] never cared what [ENTITY:character:Kaedin] thought; he wore them because they meant something.</p>
        ...
        <p>Their laughter and arguing masked the danger until it was too late. A pressure plate clicked beneath [ENTITY:npc:Thalos]'s foot, and the beacon flared to life. Dunamis energy surged through the cavern, and before [ENTITY:character:Kaedin] could act, [ENTITY:npc:Thalos] was consumed by the pulse—his form collapsing into a shimmer of light before vanishing entirely. Only his robes remained, crumpled on the stone floor. The village assumed [ENTITY:npc:Thalos] had been lost in a cave-in. But [ENTITY:character:Kaedin] knew the truth: something had taken his friend beyond the boundaries of their world. </p>
