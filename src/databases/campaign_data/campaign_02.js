...
const CAMPAIGN_02_RECAPS = [
	{
		...
		<p>The lady introduced herself as Zella, and she listened - truly listened - to [ENTITY:character:Norr]'s story. Her struggles, her fears, the confusion that had shadowed her life. And then Zella made an offer: to take [ENTITY:character:Norr] under her wing and teach her the ways of magic.</p>
		...
		<p>They spent years together. Zella taught her everything she knew, drilled every bit of magical knowledge into [ENTITY:character:Norr]'s mind. When there was nothing left to teach, she sent her student onward - to Luskan, to find the [ENTITY:guild:Arcane Brotherhood]. A place of boundless learning, where the magically gifted could find their path. A place, perhaps, to belong.</p>
		...
		<p>In memory of Thalos, no matter what he wore, [ENTITY:character:Kaedin] always donned the traditional garb over. This way he would never forget. This way he would never stop looking.</p>
		...
		<p>[ENTITY:character:Bonnie] is a fairy pixie born from the pure magic of the [ENTITY:location:Feywilds]. She had no real family - other fairies born like her could be considered one, but she never saw it that way. She had no home beyond trees and groves, caves and lakes. [ENTITY:character:Bonnie] lived her long life doing whatever she pleased, always with her trusted companion, friend, and what she would call family: Jacques, the antlered giant rat.</p>
		...
		<p>What [ENTITY:character:Bonnie] never expected in her long, chaotic life was to care for someone other than Jacques. But she did. So, she stepped forward, confessed to everything in a desperate attempt to save her friend.</p>
		
		<p>Clyde was spared. [ENTITY:character:Bonnie] was not. Exiled to the mortal plane, cut off from the [ENTITY:location:Feywilds], with no way back. Clyde was gone. Magic was... different now.</p>
		
		<p>But [ENTITY:character:Bonnie] was scrappy. She carved out a life in [ENTITY:location:Brindol], adapted to the strange new shape of her magic, and stayed close to Jacques - even if he was quite a bit smaller now than he once was. She spent her time with the Thieves' Guild, either waiting for something better to come along or searching for a way back home.</p>
		...
		<p>Beside him walks [ENTITY:character:Norr], a [ENTITY:class:Sorcerer] touched by dragon’s blood and haunted by a stolen map. Fleeing the shadows of the Arcane Brotherhood with her closest companion, she guards her secrets with sharp wit and quiet strength. Her friend, [ENTITY:character:Soshi]—a Feyborn wizard who traded whimsy for power—shares in that escape, both burdened by the Brotherhood’s darkness and driven by dreams of belonging.</p>
...
const CAMPAIGN_02_BACKGROUNDS = {
	BONNIE: {
		...
		<p>[ENTITY:character:Bonnie] is a fairy pixie born from the pure magic of the Feywilds. She had no real family - other fairies born like her could be considered one, but she never saw it that way. She had no home beyond trees and groves, caves and lakes. [ENTITY:character:Bonnie] lived her long life doing whatever she pleased, always with her trusted companion, friend, and what she would call family: Jacques, the antlered giant rat.</p>
		...
		<p>Clyde was spared. [ENTITY:character:Bonnie] was not. Exiled to the mortal plane, cut off from the Feywilds, with no way back. Clyde was gone. Magic was... different now.</p>
		...
		<p>On an errand to reach [ENTITY:location:Drellin\'s Ferry], [ENTITY:character:Bonnie] finds herself traveling with four odd companions, and while she brings trouble and pranks to their lives, she also watches their backs in her own special way.</p>`,
		shortDescription: `Bonnie is a mischievous pixie from the Feywilds who never cared for rules—only freedom, fun, and her beloved companion, Jacques the giant rat. But after befriending a reckless Quickling named Clyde and getting caught in Fey court politics, she was exiled to the mortal world to save him. Now stuck in [ENTITY:location:Brindol], smaller in magic but no less scrappy, Bonnie works with the Thieves' Guild and stirs up trouble wherever she goes. Sent on an errand to Drellin’s Ferry, she travels with four unlikely companions—bringing chaos, charm, and unexpected loyalty to the road ahead.`,
	},
	KAEDIN: {
		background: `<p>[ENTITY:character:Kaedin] was born in the mining village of Grackledorn, carved into the rugged ridges of the Earthspur Mountains near the edge of the Great Rift. The land there thrummed with old power, remnants of a time when a mighty Dao genie once struck a pact with the mountain dwarves, leaving the region steeped in latent elemental magic. Though his parents were human, [ENTITY:character:Kaedin]'s body and soul were forever marked by this place—born of stone and thunder, forged in silence and shifting earth. </p>

        <p>As a child, [ENTITY:character:Kaedin] was clever, energetic, and always on the verge of mischief. His constant partner in trouble was Thalos, the son of stoic, deeply religious Earth Genasi parents who upheld every tradition with unwavering reverence. Thalos always wore his people's ceremonial robes, stiff with cultural pride and stitched with sacred patterns of stone. [ENTITY:character:Kaedin] mocked them at first—he found them impractical, absurd for cave diving and running through the hills. But Thalos never cared what [ENTITY:character:Kaedin] thought; he wore them because they meant something.</p>

        <p>One fateful day, at only ten years old, the two friends ventured into a newly revealed tunnel in the cliffs beyond the village. The air inside was sharp with arcane charge, and the walls glittered with strange, glowing crystal veins. In the heart of that cave, they found an ancient monolith—a beacon of pure energy, covered in glowing symbols [ENTITY:character:Kaedin] would one day recognize as belonging to the Kryn Dynasty.</p>

        <p>Their laughter and arguing masked the danger until it was too late. A pressure plate clicked beneath Thalos's foot, and the beacon flared to life. Dunamis energy surged through the cavern, and before [ENTITY:character:Kaedin] could act, Thalos was consumed by the pulse—his form collapsing into a shimmer of light before vanishing entirely. Only his robes remained, crumpled on the stone floor. The village assumed Thalos had been lost in a cave-in. But [ENTITY:character:Kaedin] knew the truth: something had taken his friend beyond the boundaries of their world. </p>
        
        <p>In the months that followed, [ENTITY:character:Kaedin] began to experience disturbing visions. He would seize up with piercing headaches, and during those moments, the world seemed to warp—reflections of himself flickered across the edges of his sight, and time stuttered like a skipped breath. He saw himself fighting battles he hadn't lived, speaking words he'd never learned. He was seeing alternate versions of his life—echoes.</p>

        <p>Desperate for answers, [ENTITY:character:Kaedin] eventually traveled east, following rumors of Kryn exiles who had continued their study of dunamancy in secret. In the shadowy tunnels beneath Velkynvelve, he found them—arcane researchers, deserters, and mystics. One of them, a wizened mage named Verenn Yorr, recognized the potential in [ENTITY:character:Kaedin]'s unstable visions and offered to help.
        Under Verenn's guidance, [ENTITY:character:Kaedin] learned to harness the rifts within himself. He trained to stabilize the echoes and turn them into extensions of his will—shadows of himself pulled from other timelines, weapons shaped from the possibilities of his own existence. With discipline and will, he became something new: an Echo Knight, a warrior with one foot planted in every version of reality.
        [ENTITY:character:Kaedin] joined a soldier's company not long after, hoping to gain the discipline and experience to master his strange powers. But he never stopped searching. He wore Thalos's traditional Earth Genasi robes over his armor, adapting them to his style: long black cloaks with golden trims, chainmail hidden beneath flowing earthen fabric. The other soldiers mocked his appearance, seeing only a mystic trying to play at being a knight. That laughter quickly died on the training grounds.
        [ENTITY:character:Kaedin] never tried to correct their assumptions. He remained quiet, direct, and solitary. Many mistook his reserved nature for a lack of charisma, but [ENTITY:character:Kaedin] had long since abandoned social rituals. Every word, every action, was weighed for purpose. He did not fight for glory or gold—he fought to control the powers of fate, to learn how to step through time itself, and to find the one timeline where Thalos still lived.</p>

        <p>[ENTITY:character:Kaedin] had been tracing reports of arcane disturbances—instances where individuals claimed to have seen visions of themselves acting out moments that hadn't yet occurred. Whispers of these strange anomalies led him west, to the Elsir Vale, a land scattered with ruins of ancient civilizations and known for its thin veil between worlds. Rumors in Dennovar spoke of a ruined fortress to the north where the walls shimmered at night and shadows moved without a source.</p>

        <p>He arrived in [ENTITY:location:Brindol], the Vale's largest city, under the guise of a wandering soldier-scholar, seeking tomes and local accounts of planar rifts. His presence, though quiet, didn't go unnoticed for long.</p>

        <p>When goblin raids intensified, [ENTITY:character:Kaedin] stepped in to defend a merchant caravan during a sudden ambush. His command of echo magic—blinking in and out of reality, fighting alongside his own shadows—left survivors stunned. Word of the strange warrior reached Lord Jarmaath of [ENTITY:location:Brindol], who was desperate for capable allies as tensions in the region worsened.</p>

        <p>Their agreement was simple: [ENTITY:character:Kaedin] would scout the threat in the wilds surrounding [ENTITY:location:Brindol], confirm the reports of a united goblinoid force, identify the warlord behind it, and uncover what their endgame was.</p>

        <p>But for [ENTITY:character:Kaedin], there was more to it than a mission. He had heard rumors that the warlord, used strange tactics—ambushes that unfolded like they had foreseen their enemies' every move. It could have been coincidence. Or it could be another sign of dunamancy at work.</p>`,
		shortDescription: `Kaedin, an Echo Knight born near the Great Rift, was marked by ancient elemental magic despite his human lineage. After losing his childhood friend Thalos to a mysterious dunamis beacon, Kaedin began experiencing visions of alternate selves. His search for answers led him to secret Kryn mystics, where he learned to control his echoes. Now a stoic, battle-hardened warrior draped in Thalos's Genasi robes, Kaedin travels the Elsir Vale, hunting signs of temporal magic—hoping to master fate and find the timeline where his friend still lives.`,
	},
	OLEK: {
		background: `<p>He is devotion given form - an angelic soul clad in armor, kind and just, friendly and ever ready for conversation. [ENTITY:character:Olek] is honorable to his very core, though humble in his ways, never one to boast or seek glory.</p>
	...
	SOSHI: {
		background: `<p>[ENTITY:character:Soshi] was not born in the world of mortals. As all fey creatures do, she was born in the Feywilds - magic giving her shape and form, infusing her with the changing seasons.</p>
		...
		<p>[ENTITY:character:Soshi] buried herself in books. Arcane formulas, incantations, the elegant structure of wizardry - she consumed it all with the desperation of someone who had everything to</p>
		...
		<p>And so, we find [ENTITY:character:Soshi], her spellbook in hand and memories of the Feywild stirring in her chest, walking the winding road to [ENTITY:location:Drellin\'s Ferry].</p>`,
		shortDescription:
	...
	NORR: {
		...
		<p>They spent years together. Zella taught her everything she knew, drilled every bit of magical knowledge into [ENTITY:character:Norr]’s mind. When there was nothing left to teach, she sent her student onward - to Luskan, to find the Arcane Brotherhood. A place of boundless learning, where the magically gifted could find their path. A place, perhaps, to belong.</p>
		...
		<p>The future, like magic, is uncertain. But [ENTITY:character:Norr] walks forward - beautiful, dangerous, and full of lightning.</p>`,
		shortDescription:
			'Norr was born into hardship—an unloved child with hidden power and a storm in her soul. Discovered by a mysterious sorceress named Zella, she was offered a way out: a life of magic, purpose, and freedom. Years of mentorship led her to the Arcane Brotherhood, but the institution’s dark truths soon drove her away. With a stolen map and her closest friend at her side, Norr now travels toward Drellin’s Ferry with a new band of companions. Guarded, graceful, and brimming with untapped power, she walks into an uncertain future—beautiful, dangerous, and full of lightning.',
	},
};
