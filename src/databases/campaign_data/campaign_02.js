...
const CAMPAIGN_02_RECAPS = [
	{
		...
		content: `
			...
			<p>Here we are - our fifth hero. So far, we've heard tales of lost families, fractured selves, and friends long gone - of longings for magic, regrets for what once was, and hopes for what could be. Bonnie, however, is not like that.</p>

			<p>Bonnie is a fairy pixie born from the pure magic of the Feywilds. She had no real family - other fairies born like her could be considered one, but she never saw it that way. She had no home beyond trees and groves, caves and lakes. Bonnie lived her long life doing whatever she pleased, always with her trusted companion, friend, and what she would call family: Jacques, the antlered giant rat.</p>

			<p>Pixies are known to be a little mischievous, but rarely with a truly mean bone in them. Bonnie, however, seems to have that particular trait in spades. She found joy in rule-breaking, in taking what wasn't hers. She enjoyed doing what she wanted, when she wanted, and nothing - absolutely nothing - could stand in her way.</p>

			<p>But ah, what Bonnie did not anticipate was that fate had plans for her, too. One lovely morning, while dodging a swarm of angry Summer Court Sprites, she ran headfirst into someone who had no business being this deep in the Feywilds - a Quickling by the name of Clyde. Now, Bonnie didn't care for rules, and instead of reporting the trespasser, she befriended him.</p>
			...
			<p>What Bonnie never expected in her long, chaotic life was to care for someone other than Jacques. But she did. So, she stepped forward, confessed to everything in a desperate attempt to save her friend.</p>

			<p>Clyde was spared. Bonnie was not. Exiled to the mortal plane, cut off from the Feywilds, with no way back. Clyde was gone. Magic was... different now.</p>

			<p>But Bonnie was scrappy. She carved out a life in Bryndol, adapted to the strange new shape of her magic, and stayed close to Jacques - even if he was quite a bit smaller now than he once was. She spent her time with the Thieves' Guild, either waiting for something better to come along or searching for a way back home.</p>

			<p>And maybe, just maybe, that something finally did.</p>

			<p>On an errand to reach Drellin's Ferry, Bonnie finds herself traveling with four odd companions, and while she brings trouble and pranks to their lives, she also watches their backs in her own special way.</p>
			<hr>
...
const CAMPAIGN_02_BACKGROUNDS = {
	BONNIE: {
		background: `<p>So far, we’ve heard tales of lost families, fractured selves, and friends long gone - of longings for magic, regrets for what once was, and hopes for what could be. Bonnie, however, is not like that.</p>
	...
	KAEDIN: {
        ...
        <p>When goblin raids intensified, Kaedin stepped in to defend a merchant caravan during a sudden ambush. His command of echo magic—blinking in and out of reality, fighting alongside his own shadows—left survivors stunned. Word of the strange warrior reached Lord Jarmaath of Brindol, who was desperate for capable allies as tensions in the region worsened.</p>

        <p>Their agreement was simple: Kaedin would scout the threat in the wilds surrounding Brindol, confirm the reports of a united goblinoid force, identify the warlord behind it, and uncover what their endgame was.</p>

        <p>But for Kaedin, there was more to it than a mission. He had heard rumors that the warlord, used strange tactics—ambushes that unfolded like they had foreseen their enemies' every move. It could have been coincidence. Or it could be another sign of dunamancy at work.</p>`,
